...
$profile_creator = $_REQUEST['id'];
$today = $_REQUEST['start'];
$later = date('Y-m-d 23:59:59', strtotime('+0 days', strtotime($_REQUEST['end'])));
...
Closing balance : N'.formatDollars(($closingbalance+$mybal)).'<br />
