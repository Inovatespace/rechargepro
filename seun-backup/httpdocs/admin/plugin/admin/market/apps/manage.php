...
<div style="float:left;  margin-right:40px; padding-left:20px;">Purchased Plugin</div>
...
<div class="unmenu barmenu" style="width:20%;">Type</div>
...
<div class="first_li submenu" accesskey="site"><span style="width:17px; border-right:1px solid #E2E2E2;  padding:5px 2px;"><img src="../../images/icons/check_light.png" width="14" height="14" /></span><span>open app in new tab</span></div></div>       
