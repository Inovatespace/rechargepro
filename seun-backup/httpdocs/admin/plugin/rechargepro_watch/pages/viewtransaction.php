...
<span class="fa fa-plus tunnel" name="plugin/rechargepro_watch/pages/upload.php?width=500&id=<?php echo $id;?>" style="cursor:pointer; font-size: 150%; color:#1D8E32;"></span>
</div><?php
	}
?>
<?php
...
<?php
$row = $engine->db_query2("SELECT transactionid,transaction_reference,rechargepro_service,rechargepro_status,amount,transaction_date,account_meter FROM rechargepro_transaction_log WHERE rechargeproid = ? ORDER BY transactionid DESC LIMIT 50", array($id));
