...
active = "1";
        ...
        if (searchbox == '') {
            ...
            $.ajax({
                type: "POST",
                url: "plugin/rechargepro_billers/pages/billb.php",
                data: dataString,
                cache: false,
...
<div style="float: left; width:40%;"><input autocomplete="off" id="search" type="text" placeholder="Name / Code" style="width: 90%;" class="input" /></div>
 ...
 <?php if($permission >= 3){ ?>
<a href="rechargepro_billers&p=newbiller"><div style="float: right; font-size: 200%; color:#088427;" class="fas fa-plus-square"></div></a><?php
	}
?>
</div>
...
<?php $rowcount = $engine->db_query2("SELECT id FROM rechargepro_services", array(), true);?>
<script type="text/javascript">
