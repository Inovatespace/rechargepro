...
$pdf->Cell(60,5,"amount indicated above Pursuant to Section 86 of the Enugu State Road  Traffic Law 2012, You are liable ",0,1,'L');  
$pdf->Cell(60,5,"for the fine because at the time, date and location indicated above, the driver of your vehicle, in violation of Section 86 of ",0,1,'L');  
$pdf->Cell(60,5,"the Enugu State Road  Traffic Law 2012, committed the offence stated above. You must pay your fine by the ",0,1,'L');  
$pdf->Cell(100,5,"payment due date indicated above,  or pay a demurrage fine of "); 
$pdf->SetFont('Arial','B',10);
$pdf->Cell(50,5,"Five Hundred Naira (N500)");
$pdf->SetFont('Arial','',10); 
...
$pdf->Image("../evidence/".$carnumber.'a.png',10,87,0,70);
}

if(file_exists("../evidence/".$carnumber."b.png")){
$pdf->Image("../evidence/".$carnumber.'b.png',70,87,0,70);
}

if(file_exists("../evidence/".$carnumber."c.png")){
$pdf->Image("../evidence/".$carnumber.'c.png',10,87,0,70);
}

if(file_exists("../evidence/".$carnumber."d.png")){
$pdf->Image("../evidence/".$carnumber.'d.png',70,87,0,70);
}
