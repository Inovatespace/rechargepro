...
<script src="plugin/rechargepro_account/pages/import/js/vendor/jquery.ui.widget.js"></script>
<!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
<script src="plugin/rechargepro_account/pages/import/js/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="plugin/rechargepro_account/pages/import/js/jquery.fileupload.js"></script>
...
//$(function () {
   // 'use strict';
    ...
    var url = 'plugin/rechargepro_account/pages/uploadpro.php';
