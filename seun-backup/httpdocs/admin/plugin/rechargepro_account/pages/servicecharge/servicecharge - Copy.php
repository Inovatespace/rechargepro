...
$rowb = $engine->db_query2("SELECT id FROM rechargepro_services_agent WHERE rechargeproid = ? AND services_key = ?",array($sentid,$services_key));
if(!empty($rowb[0]['id'])){
$weid = $rowb[0]['id']; 
$engine->db_query2("UPDATE rechargepro_services_agent SET cordinator_percentage=?, percentage=?, bill_formular=?, bill_rechargeprofull_percentage=? WHERE id = ?",array($cordinator,$agent,$what,$newvertise,$weid));
}else{
...
$rowb = $engine->db_query2("SELECT id FROM rechargepro_services_agent WHERE rechargeproid = ? AND services_key = ?",array($sentidb,$services_key));
if(!empty($rowb[0]['id'])){
$weid = $rowb[0]['id']; 
$engine->db_query2("UPDATE rechargepro_services_agent SET cordinator_percentage=?, percentage=?, bill_formular=?, bill_rechargeprofull_percentage=? WHERE id = ?",array($cordinator,$agent,$what,$newvertise,$weid));
...
//SERVICE CHARGE
if($servicecharge > 0){
$rowb = $engine->db_query2("SELECT id FROM rechargepro_services_fixed WHERE rechargeproid = ? AND services_key = ?",array($sentid,$services_key));
if(!empty($rowb[0]['id'])){
$weid = $rowb[0]['id']; 
$engine->db_query2("UPDATE rechargepro_services_fixed SET fixedfee=? WHERE id = ?",array($servicecharge,$weid));
}else{
...
foreach($mypeople AS $sentidb){
$rowb = $engine->db_query2("SELECT id FROM rechargepro_services_fixed WHERE rechargeproid = ? AND services_key = ?",array($sentidb,$services_key));
if(!empty($rowb[0]['id'])){
$weid = $rowb[0]['id']; 
$engine->db_query2("UPDATE rechargepro_services_fixed SET fixedfee=? WHERE id = ?",array($servicecharge,$weid));
