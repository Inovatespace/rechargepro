...
active = "1";
        ...
        if (searchbox == '') {
            ...
            $.ajax({
                type: "POST",
                url: "plugin/rechargepro_disbursement/pages/disbursementb.php",
                data: dataString,
                cache: false,
...
<input type="text" class="input" style="width:99%; padding:10px;"/>
</div>
...
<button class="activemenu shadow" style=" padding:10px; border: none; margin-top:15px;">PAY</button>
</div>
...
<?php $rowcount = $engine->db_query2("SELECT id FROM rechargepro_bulkpay_transactions_log", array(), true);?>
<script type="text/javascript">
