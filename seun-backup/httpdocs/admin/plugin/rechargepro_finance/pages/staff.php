...
function call_page(page,type="1"){
     ...
     $("#page-content").html('<img src="../theme/classic/images/loading.gif" width="124" height="124" />');
            ...
            $.ajax({
                type: "POST",
                url: "plugin/rechargepro_finance/pages/staffa.php",
...
function load_myagentb(Id){
   load_myagent(Id,currentpage,currenttype); 
}


var currentpage = null;
var currenttype = null;
   function load_myagent(Id,Page,type){

currentpage = Page;
currenttype = type;

$("#myagent").html('<img src="../theme/classic/images/loading.gif" width="124" height="124" />');

            $.ajax({
                type: "POST",
                url: "plugin/rechargepro_finance/pages/staffb.php",
