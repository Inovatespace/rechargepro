    ...
    $.fn.extend({
        smartpaginator: function (options) {
            ...
            return this.each(function () {
                ...
                var list = $('<ul/>');
                var btnPrev = $('<div/>').attr('id', 'previous').text(settings.prev).click(function () { if ($(this).hasClass('disabled')) return false; currentPage = parseInt(list.find('li a.active').text()) - 1; navigate(--currentPage); }).addClass('btn2');
;
                var btnNext = $('<div/>').attr('id', 'next').text(settings.next).click(function () { if ($(this).hasClass('disabled')) return false; currentPage = parseInt(list.find('li a.active').text()); navigate(currentPage); }).addClass('btn2');
                ...
                var inputPage = $('<input/>').addClass('input').attr('type', 'text').keydown(function (e) {
