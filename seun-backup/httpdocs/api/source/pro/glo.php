...
class glo extends Api
{
 ...
 ////////////////////////////////// AUTO FEED END
        ...
        $response = self::vendglo($tid, self::fix_phone($accountnumber), $amount, $thirdPartyCode,
            $district);
        ...
        if ($response['status'] == "200") {
            ...
            if ($response['status'] == "100000") {
                ...
                return array("status" => "100", "message" =>
                        "An error occured please contact support with TID $tid 7");
 ...
 <soapenv:Body>
    ...
    file_put_contents("ddd.txt",$result."@".$code."@".$err."@seun");
        ...
        if ($all_data === false) {
            ...
            self::db_query("INSERT INTO rechargepro_transaction_log (rechargepro_print) VALUES (?)",
                array($response));
        } else {
