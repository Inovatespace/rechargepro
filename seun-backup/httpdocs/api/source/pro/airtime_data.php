...
class airtime_data extends Api
{
    ...
    public function auth_airtime($parameter)
    {
        ...
        if ($service == "23541111111111111111111111111111") {
            include "glo.php";
            $glo = new glo("POST");
    ...
    public function auth_data($parameter)
    {
        ...
        if ($service == "ADCCCCCCCCCCCCCCCCCCCCC") {
            include "glo.php";
            $glo = new glo("POST");
...
{"isAvailable":true,"ercValue":"DATA-33","price":20000,"name":null,"allowance":"78.7GB 30 days","validity":"30 days"}
        ...
        "ADC",
            ...
            if ($service == "ACC") {
                $response = self::mobifin_post("datatopup/info/2349024667096", "", false);
                        ...
                        if ($service == "ADC") {
                $response = self::mobifin_post("datatopup/info/2349059667235", "", false);
            }
    ...
    public function complete_transaction($parameter)
    {
        ...
        if (in_array($service, array("ADCCCCCCCCCCCCCCCCCCCC", "2354111111111111111111111111"))) {
            include "glo.php";
            $glo = new glo("POST");
        ...
        if ($amount < 1) {
            return array("status" => "100", "message" =>
                    "Payment Not successful please contact support with TID $tid 2");
        }
    ...
    "send_sms" : false,
    "sms_text" : "",
    "customer_reference":"RECH' . $transaction_date . $tid . '"
}';
