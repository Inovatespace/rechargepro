...
$this->pub_key = "707642f09dff491e0737d01e3977d7e8";
$this->priv_key = "2e3ce0dfdeab73c4233560698d8f8c61753bf9cb0271cd73c705152f8e72b23fc35eb1afc846726e7c9a1fb7c6ff5cdfb2402e8487733076801afb4b14681647";
$this->vendor_code = "1709A4AB41";
    ...
    switch ($service){ 
    	...
    	case "AEP": $disco = "AEDC_Postpaid";
    	break;
    }


//generate a unique ID
$reference_id = "333333333";
//concatenate variables using character | and compute hash
$combined_string = $this->vendor_code."|".$reference_id."|".$accountnumber."|".$this->pub_key;
$hash = hash_hmac("sha1", $combined_string, $this->priv_key);
//create URL
$url = "https://irecharge.com.ng/pwr_api_sandbox/v2/get_meter_info.php?vendor_code=".urlencode($this->vendor_code)."&meter=".urlencode($accountnumber)."&reference_id=".urlencode($reference_id)."&disco=".urlencode($disco)."&response_format=json&hash=".urlencode($hash);
	  ...
	  $curl = curl_init();
        ...
        $response = json_decode($result, true);
         ...
         file_put_contents("d.php",$result);
