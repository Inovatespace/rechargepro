...
class percentage extends Api
{
    ...
    function calculate_per($parameter)
    {
        ...
        if ($rechargeproid == 0) {
            $percent = ($percentage + $cordinator_percentage + $bill_rechargeprofull_percentage) - (($amount *
                1.5) / 100);
            if ($bill_formular == 0) {
                $percent = (($amount * ($percentage + $cordinator_percentage + $bill_rechargeprofull_percentage)) /
                    100) - (($amount * 1.5) / 100);
            }
            ...
            array($newrechargepro_service_charge,$itd));
                ...
                if ($rechargeprorole < 4) {
                    ...
                    if ($corprofit > 0) {
                        ...
                        $rechargepropercentage = $bill_rechargeprofull_percentage;
                        if ($bill_formular == 0) {
                            $rechargepropercentage = ($amount * $bill_rechargeprofull_percentage) / 100;
                        }

                    } else {


                        $rechargepropercentage = $bill_rechargeprofull_percentage + $cordinator_percentage;
                        if ($bill_formular == 0) {
                            $rechargepropercentage = ($amount * ($bill_rechargeprofull_percentage + $cordinator_percentage)) /
                                100;
                        }
                    ...
                    $percent = ($percentage + $cordinator_percentage + $bill_rechargeprofull_percentage);
                    if ($bill_formular == 0) {
                        $percent = (($amount * ($percentage + $cordinator_percentage + $bill_rechargeprofull_percentage)) /
                            100);
                    }
