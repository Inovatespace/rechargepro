...
$row = $engine->db_query("SELECT ac_ballance,profile_creator,profile_agent,rechargeprorole FROM rechargepro_account WHERE rechargeproid = ? LIMIT 1",array($profile_creator));
...
if($engine->get_session("rechargeprorole") == "1"){
...
$("#loadcontent").html('<div style="text-align:center; padding:20px;"><img src="/theme/classic/images/rechargepro.gif" width="124" height="124" /></div>');
