<div style="" class="title_api4">Get list of Bills</div>
 <style>
         pre {
            overflow-x: auto;
...
<?php
$array = array("private_key"=>"1234QWER5678TYUI","token"=>"1234:QWER:5678:TYUI","cat"=>"1");
$link = 'https://rechargepro.com.ng/api/public/transaction/bills_list.json';
?>
