...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => '../../../../tmp/',//dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/',
            'upload_url' => '../../../../tmp/',//$this->get_full_url().'/files/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'inline_file_types' => '/.+$/i',//'/\.(gif|jpe?g|png)$/i',
