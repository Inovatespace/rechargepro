...
require_once AUTH_DOCROOT . '/engine/library/Purifier/HTMLPurifier.auto.php';
...
function url_origin($use_forwarded_host = false )
{
    ...
    public function curlit($from, $message, $sender="RechargePro")
    {
        ...
        // Set a referer
        curl_setopt($ch, CURLOPT_REFERER, "http://rechargepro.com");
        // User agent
    ...
    function myarray()
    {
        $array = array(
            ...
            "DYA",
            "TransactionID",
            "retailer_id","Vat","Tariff","TariffRate","LastPurchase","Account Type","Website","Date","Address");
