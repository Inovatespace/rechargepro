...
<style type="text/css">
#breadcrumb{float: left; color:white; font-size:140%;}
...
<input class="outline" type="text" id="search" placeholder="Search" onkeyup="call_search()" style="width:72.5%; float: right; padding:8px 0.5%; border: none; margin-right:0.5%;" /> 
</div>
</div>
...
<div class="transparent" style="z-index:1; background-color: black; height: 820px; width:100%; position: absolute;">&nbsp; </div>
...
<!--  #3B3B3B -->
<div class="mainbg" style="background-color:#3B3B3B; padding-top:5px;">
<div style="text-align:center;">
<div style="display: inline-block;"><a href="https://play.google.com/store/apps/details?id=com.mcbpay.mcbpay"><img src="theme/classic/images/1.png" style="height: 42px;" /></a></div>
<div style="display: inline-block;"><img src="theme/classic/images/2.png" style="height: 42px;"   /></div>
...
<div class="row">
  <div class="column">
  <div class="fab fa-joomla" style="color: #5290F3; font-size:300%;"></div>
  <div style="font-size: 200%; font-weight:700; margin:10px 0px;">Low Cost</div>
  <div style="line-height: 155%;">our online mobile recharge transaction is completely guaranteed and secure.Earn reward points & get bonus anytime, anywhe</div>
  </div>
  
  
  <div class="column">  <div class="fab fa-joomla" style="color: #5290F3; font-size:300%;"></div>
  <div style="font-size: 200%; font-weight:700; margin:10px 0px;">Super Fast</div>
  <div style="line-height: 155%;">our online mobile recharge transaction is completely guaranteed and secure.Earn reward points & get bonus anytime, anywhe</div></div>
  ...
  <div style="line-height: 155%;">our online mobile recharge transaction is completely guaranteed and secure.Earn reward points & get bonus anytime, anywhere</div></div>
</div>
</div>
...
<style type="text/css">
.ref_title{font-size: 200%; font-weight:700; margin:20px 0px;}
#ref-1{background-color: #303443; height:250px; width:28%; margin-right:1%; display: inline-table; padding:20px 2%; }
#ref-2{background-color: #303443; height:250px; width:28%; margin-right:1%; display: inline-table; padding:20px 2%;}
#ref-3{background-color: #303443; height:250px; width:28%; margin-right:1%; display: inline-table; padding:20px 2%;}
@media (max-width: 750px) {
.ref_title{font-size: 150%; font-weight:400; margin:10px 0px;}
...
<div id="ref-1">
 ...
 <a href="/invite"> <button class="radious20" style="width:50%; color:white; background-color: #303443; border: solid 2px #3880F4; font-size:120%; padding:10px 20px;">Invite/Refer</button></a>
  </div>
  
  
<div id="ref-2"> <div class="fab fa-joomla" style="color: #5290F3; font-size:300%;"></div>
  <div class="ref_title" style="line-height: 300%;">Join Us Right Now</div>
  <a href="/register"><button class="radious20" style="width:50%; cursor:pointer; color:white; background-color: #303443; border: solid 2px #3880F4; font-size:120%; padding:10px 20px;">Register</button></a></div>
...
<div style="margin-left:auto; margin-right:auto; width:70%; overflow: hidden; margin-bottom:20px; position: relative;">
<input class="radious20 outline" type="text" style="background-color: #303443; color:white; border:solid 2px #595D69; width:85%; padding:14px; position: relative;"  placeholder="Search Location"/>
<a href="/find"><input class="radious20 outline" type="button" style="cursor:pointer; background-color:#3880F4; color:white; border:solid 2px #595D69;   padding:14px; position: absolute; top:0px; right:0px; font-weight: bold;" value="Search"/></a>
</div>
</div>
...
<div style="border: solid 2px #E4E5E6; padding: 15px 30px; display: block; overflow: hidden;"><div style="float: left;">Who can be an Agent?</div> <div style="float: right; cursor:pointer;  width:20%; text-align: right; color: #5290F3;" class="fas ques fa-minus-square" id="qq1" onclick="queation('1')"></div></div>
...
<div  id="q6" class="answer" style="display:none; border: solid 2px #E4E5E6; border-top:none; padding: 30px; padding-top: 10px; background-color:white;">For instant crediting make bank-deposit/transfer to the account number below, use your rechargepro phone number as narration/description:<br/>
