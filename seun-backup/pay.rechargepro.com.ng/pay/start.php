...
$local_signature = "lovequickpay";//getenv('SECRET_HASH');
...
$engine->db_query("INSERT INTO quickpay_transaction_log (bank_ref,quickpay_status) VALUES (?,?)", array($response,"PAID"));  
...
$engine->db_query("UPDATE quickpay_transaction_log	SET bank_ref=?, bank_response=? WHERE transactionid = ?", array($bank_ref,$response,$next_ref));
