...
class smile extends Api
{
    ...
    public function auth_airtime($parameter)
    {
        ...
        $requestBody = '{"details": {"customerAccountId": "' . $accountnumber .
            '","requestType": "VALIDATE_ACCOUNT"},"serviceId": "ANA"}';
 ...
 //return array("status" => "100", "message" => $result . $err . $code);
    ...
    public function auth_data($parameter)
    {
        ...
        $requestBody = '{"details": {"customerAccountId":"' . $accountnumber .
            '","requestType": "VALIDATE_ACCOUNT"},"serviceId": "ANB"}';
    ...
    public function complete_transaction($parameter)
    {
        ...
        if ($service == "ANA") {
            $response = self::mobifin_post("api/billpay/internet/BPI-NGCA-ANA/" . $amount, $requestBody, true);
        } else {
            $response = self::mobifin_post("api/billpay/internet/BPI-NGCA-ANB/" . $thirdPartyCode,
                $requestBody, true);
        }
        //data
