...
<div style="float: left; width:25%;">Email<span class="important">*</span></div>
<div style="float: left; width:69%;"><input value="<?php echo $engine->get_session("quickpayemail");?>" class="input" readonly="readonly" type="text" name="email" style="width:99%; padding:5px 0px;"/></div>
<div style="clear: both; border-bottom:dotted 1px #969292; height:8px; margin-bottom:5px;">&nbsp;</div>
<?php
	}
?>
...
<div style="float: left; width:25%;"><img id="loading" style="width: 20%; display:none;" src="/theme/classic/images/quickpay.gif"  /></div>
