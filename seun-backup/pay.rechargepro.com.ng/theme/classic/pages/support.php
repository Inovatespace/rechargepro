...
<div class="sitewidth" style="margin-left:auto; margin-right:auto; padding:10px; overflow: hidden; margin-top: 150px;">
...
$("#call").html('<img src="/theme/classic/images/images/quickpay.gif"  />');  
...
$("#acholder").html('<img src="/theme/classic/images/quickpay.gif"  />');  
...
<div style="border: solid 2px #E4E5E6; padding: 15px 30px; display: block; overflow: hidden;"><div style="float: left;">Who can be a quickpay Agent?</div> <div style="float: right; cursor:pointer;  width:20%; text-align: right; color: #5290F3;" class="fas ques fa-minus-square" id="qq1" onclick="queation('1')"></div></div>
<div id="q1" class="answer" style="border: solid 2px #E4E5E6; border-top:none; padding: 30px; padding-top: 10px; background-color:white;">Individuals, small scale businesses, companies, institutions etc. can become quickpay Agents provided they have at least minimum required documents and funds.</div>
</div>
...
<strong>Description</strong>: &lt;Your QuickPay Phone Number&gt;
</div>
