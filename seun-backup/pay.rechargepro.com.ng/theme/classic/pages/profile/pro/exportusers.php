...
$row1 = array("SN","quickpayid","name","live_account","status","process_transaction","email","mobile","ballance","call_back_url","bank_name","bank_ac_name","bank_ac_number","last_payout","created_date");
$line1 = "";
$comma1 = "";
...
$sn = 0;
 $row = $engine->db_query("SELECT quickpayid,name,active,email,mobile,ac_ballance,call_back_url,bank_name,bank_ac_name,bank_ac_number,last_payout,created_date FROM quickpay_account WHERE profile_creator = ?",array($engine->get_session("adminid"))); 
