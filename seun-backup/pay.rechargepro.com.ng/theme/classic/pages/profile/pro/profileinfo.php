...
<?php
$row = $engine->db_query("SELECT name,email,mobile,ac_ballance,call_back_url,bank_name,bank_ac_name,bank_ac_number,created_date FROM quickpay_account WHERE quickpayid = ?",array($id));
